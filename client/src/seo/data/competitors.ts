...
export const competitorList: CompetitorData[] = [
  {
    slug: 'tinder',
    name: 'Tinder',
    category: 'Mainstream Social App',
    title: 'Othrhalff vs Tinder – The Verified Campus Connection Alternative',
    tagline: 'Ditch swipe fatigue. Connect with verified college peers on your campus anonymously.',
    summary:
      'Tinder is a global swipe app flooded with bots, unverified profiles, and superficial matching. Othrhalff is built exclusively for university students with campus email verification, instant 1-on-1 speed text and video chats, and anonymous confession boards.',
    features: [
      ...
      { name: 'Instant Speed Text & Video Chats', othrhalff: 'HD WebRTC Speed Chat', competitor: 'Text Only After Matching', othrhalffHas: true, competitorHas: false },
  ...
  },
  {
    slug: 'bumble',
    name: 'Bumble',
    category: 'Social Matching App',
    title: 'Othrhalff vs Bumble – Verified Campus Connections & Speed Video Chat',
    tagline: 'Equal speed matching for college students with zero 24-hour expiration timers.',
    summary:
      'Bumble enforces artificial 24-hour message timers and unverified global pools. Othrhalff provides real-time peer connection with audio sound cues, interest topic matching, and instant connection unlocking for college peers.',
    features: [
      ...
      { name: 'Instant Real-time Campus Matching', othrhalff: 'Live Text & Video Pool', competitor: 'Asynchronous Swiping', othrhalffHas: true, competitorHas: false },
    ...
    verdict:
      'Othrhalff provides a faster, pressure-free campus connection experience tailored directly to university life in India.',
  },
  {
    slug: 'hinge',
    name: 'Hinge',
    category: 'Prompt-Based App',
    title: 'Othrhalff vs Hinge – Real-Time Campus Connections & Student Network',
    tagline: 'From static profile prompts to dynamic speed text and video chats on campus.',
    summary:
      'Hinge focuses on static profile prompts and slow asynchronous messaging. Othrhalff brings dynamic speed text and video connections to your college campus with live typing indicators, sound effects, and anonymous student feeds.',
    features: [
      ...
      { name: 'Live Speed Video & Audio Chats', othrhalff: 'Built-in WebRTC Calls', competitor: 'Text Chat Only', othrhalffHas: true, competitorHas: false },
    ...
    verdict:
      'Othrhalff outperforms Hinge for college students by combining campus-verified trust with real-time campus connection.',
  },
  {
    slug: 'yikyak',
    name: 'Yik Yak & Fizz',
    category: 'Anonymous Campus Boards',
    title: 'Othrhalff vs Yik Yak & Fizz – Anonymous Campus Confessions & Live Connections',
    tagline: 'Turn anonymous campus chatter into real 1-on-1 student connections and chats.',
    summary:
      'Legacy anonymous apps like Yik Yak and Fizz offer static text boards with no built-in 1-on-1 speed video features. Othrhalff combines anonymous campus confessions with live speed text and video connections.',
    features: [
    ...
    verdict:
      'Othrhalff takes the best part of anonymous campus boards and connects it directly to real 1-on-1 campus connections.',
  },
  {
    slug: 'omegle',
    name: 'Omegle',
    ...
    features: [
      ...
      { name: '1-on-1 Speed Video Chat', othrhalff: 'HD WebRTC Speed Chat', competitor: 'Shut Down / Low Quality', othrhalffHas: true, competitorHas: false },
