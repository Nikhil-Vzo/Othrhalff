...
export const OptionWheel = ({
  ...
  useEffect(() => {
    // Force a frame run after DOM refs are assigned
  ...
  }, [items, fontSize, spacing, curve, tilt, blur, fade, minOpacity, side, loop, smoothing, applyTarget, runFrame]);
    ...
    >
      {items.map((label, index) => (
        <div
          ...
          } ${selectedIndex === index ? 'font-black font-geist tracking-tight' : 'font-bold font-geist tracking-tight'}`}
