...
const Footer: React.FC = () => (
  <footer className="relative border-t border-gray-900 bg-black/95 pb-8 pt-12 text-white sm:pt-16">
    <div className="mx-auto max-w-7xl px-5 sm:px-8">
      <div className="grid grid-cols-2 gap-8 pb-10 sm:gap-12 md:grid-cols-4 md:pb-14">
        <div className="col-span-2">
          <div className="flex items-center gap-2">
            <Ghost className="h-5 w-5 text-[#F45D9B]" />
            <span className="text-lg font-bold tracking-tight">OthrHalff</span>
          </div>
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-gray-500">
            The campus is already full of your people. We just make the signal easier to find.
          </p>
          <div className="mt-6 flex gap-3">
            <a href="https://www.instagram.com/othrhalff/" target="_blank" rel="noopener noreferrer" aria-label="Othrhalff on Instagram" className="flex h-10 w-10 items-center justify-center rounded-full bg-white/7 text-gray-400 transition-all hover:scale-110 hover:bg-[#F45D9B] hover:text-white">
              <Instagram className="h-5 w-5" />
            </a>
            <Link href="/about" aria-label="About Othrhalff" className="flex h-10 w-10 items-center justify-center rounded-full bg-white/7 text-gray-400 transition-all hover:scale-110 hover:bg-[#F45D9B] hover:text-white">
              <Ghost className="h-5 w-5" />
            </Link>
          </div>
        </div>
        <div>
          <h3 className="font-mono text-[10px] font-bold tracking-[.15em] text-white/50">COMPANY</h3>
          <ul className="mt-5 space-y-3 text-sm text-gray-500">
            <li><Link href="/about" className="transition-colors hover:text-[#F45D9B]">About Us</Link></li>
            <li><Link href="/developers" className="transition-colors hover:text-[#F45D9B]">Developers</Link></li>
            <li><Link href="/careers" className="transition-colors hover:text-[#F45D9B]">Careers</Link></li>
            <li><Link href="/contact" className="transition-colors hover:text-[#F45D9B]">Contact</Link></li>
          </ul>
        </div>
        <div>
          <h3 className="font-mono text-[10px] font-bold tracking-[.15em] text-white/50">THE BORING STUFF</h3>
          <ul className="mt-5 space-y-3 text-sm text-gray-500">
            <li><Link href="/privacy" className="transition-colors hover:text-[#F45D9B]">Privacy</Link></li>
            <li><Link href="/terms" className="transition-colors hover:text-[#F45D9B]">Terms</Link></li>
            <li><Link href="/safety" className="transition-colors hover:text-[#F45D9B]">Safety</Link></li>
            <li><Link href="/guidelines" className="transition-colors hover:text-[#F45D9B]">Guidelines</Link></li>
          </ul>
        </div>
      </div>
      <div className="flex flex-col items-center justify-between gap-3 border-t border-white/8 pt-6 text-xs text-gray-600 md:flex-row">
        <span>© {new Date().getFullYear()} Othrhalff Inc. All rights reserved.</span>
        <span className="font-mono text-[10px] tracking-[.12em]">MADE FOR THE IN-BETWEEN MOMENTS</span>
      </div>
    </div>
  </footer>
);
