-- ==============================================================================
-- CAMPUS PCO (24/7 RADIO) & ADMIN SYSTEM PRODUCTION SCHEMA & SECURITY PATCH
-- ==============================================================================
...
CREATE TABLE IF NOT EXISTS public.admin_users (
  ...
  role TEXT DEFAULT 'pco_admin', -- 'pco_admin', 'super_admin'
  added_by UUID REFERENCES auth.users(id) ON DELETE SET NULL,
  created_at TIMESTAMPTZ DEFAULT NOW()
);

-- 2. Add is_admin column to profiles table if not present
DO $$ 
BEGIN
  IF NOT EXISTS (
